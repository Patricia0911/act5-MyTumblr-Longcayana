        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    ...
                    <div class="media-body mb-5 text-white">
                        <h4 class="mt-0 mb-0">Patricia Monick Longcayana</h4>
                        <p class="small mb-4"> <i class="fas fa-map-marker-alt mr-2"></i>Mogpog Marinduque PH
                         </p>
                    </div>
                </div>
            </div>
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">100</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Following</small>
                    </li>
                </ul>
            </div>
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="font-italic mb-0">Cooking</p>
                    <p class="font-italic mb-0">Filipino- English Speaking</p>
                </div>
            </div>
